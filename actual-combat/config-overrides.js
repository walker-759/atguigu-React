 ...
 */
const { override, fixBabelImports, addPostcssPlugins,addLessLoader,addDecoratorsLegacy,addWebpackAlias } = require('customize-cra');
...
module.exports = override(
    ...
    // 不用下包
    addWebpackAlias({
        "@page": resolvePath("page"),
        "@layouts":resolvePath("layouts"),
        "@com":resolvePath("common"),
        "@uti":resolvePath("utils"),
        "@api":resolvePath("api")
    })
